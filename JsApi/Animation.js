/**
 ...
 @property {Number} factor (READONLY) Seconds elapsed since the last game tick
*/
function Animation(){
	...
	/**
	 ...
	 @param {Boolean} looping If set to true, frames won't be deleted but rotate in the queue
	...
	*/
	...
	/**
	 ...
	 @param {Integer} first The index of the first frame to be deleted
	 @param {Integer} length The number of frames to be deleted
	*/
	this.deleteFrames = function(){
		//[native code]
	}
	...
	/**
	 ...
	 @param {Object} object The object of the animated property
	 @param {String} property The name of the animated property
	 @returns {Object} The animation track's information as a hash map
	*/
	...
	/**
	 ...
	 @returns {Function} Returns the callback function as identifier for this timer
	*/
	...
	/**
	 ...
	 @returns {Boolean} Returns true on success or false if the timer was not found
	*/
