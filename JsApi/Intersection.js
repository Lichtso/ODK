...
function Intersection(){
	...
	/**
	 ...
	 @returns {Object} A hash map containing the objects that intersect with the ray, the hit points and hit normals
	*/
	...
	/**
	 ...
	 @param {Integer} filterMask Default is 0xFFFF
	 @returns {BaseObject[]} A array containing the objects that intersect with the AABB
	*/
	...
	/**
	 ...
	 @param {Integer} filterMask Default is 0xFFFF
	 @returns {BaseObject[]} A array containing the objects that intersect with the sphere
	*/
